...
const commonClasses = {
  ...
  gradientText: "bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent",
  gradientBorder: "bg-gradient-to-r from-brand-orange to-orange-500",
  glassEffect: "backdrop-blur-md border border-white/10",
  hoverGlow: "group-hover:opacity-100 transition-all duration-500",
  cardHover: "group-hover:scale-110 transition-transform duration-300"
}
        ...
        <Link href="/" className="flex items-center space-x-2 group">
          <div className="relative">
            <Image
              ...
              width={32}
              height={32}
              className={clsx("h-8 w-8 md:h-10 md:w-10", commonClasses.cardHover)}
              priority
            />
...
const HeroSection = () => (
  <section className="relative h-[calc(100vh-5rem)] flex flex-col">
    ...
    <div className="relative z-30 h-full flex flex-col justify-center items-center px-4">
      <div className={clsx(commonClasses.container, "text-center max-w-6xl")}>
        <motion.div
...
const StatsSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-900 to-gray-800 relative overflow-hidden">
      ...
      <div className={clsx(commonClasses.container, "relative")}>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
...
const CTASection = () => (
  <section className="py-24 bg-gradient-to-br from-brand-orange via-orange-500 to-orange-600 relative overflow-hidden">
    ...
    <div className={clsx(commonClasses.container, "text-center relative")}>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
