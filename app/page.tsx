    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="py-24 bg-gradient-to-b from-gray-800 to-gray-850 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-brand-orange/5 to-orange-500/5 rounded-full blur-xl animate-pulse" />
          <div className="absolute top-60 right-20 w-20 h-20 bg-gradient-to-br from-brand-orange/10 to-orange-500/10 rounded-lg rotate-45 blur-lg" />
          <div className="absolute bottom-40 left-1/4 w-24 h-24 bg-gradient-to-br from-brand-orange/8 to-orange-500/8 rounded-full blur-xl" />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {loading ? (
              ...
              featuredProperties.map((property, index) => (
                ...
                >
                  {/* Glow effect */}
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-brand-orange/20 to-orange-500/20 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-all duration-500" />
      ...
      <section className="py-24 bg-gradient-to-b from-gray-900 to-gray-800 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,#F97316_1px,transparent_1px)] bg-[size:50px_50px] opacity-5" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_25%_25%,#F97316_1px,transparent_1px)] bg-[size:30px_30px] opacity-3" />
          <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-gradient-to-br from-brand-orange/5 to-transparent rounded-full blur-3xl" />
          <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-gradient-to-bl from-orange-500/5 to-transparent rounded-full blur-3xl" />
        </div>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            {[
              ...
              >
                {/* Glow effect */}
                <div className="absolute -inset-4 bg-gradient-to-r from-brand-orange/10 to-orange-500/10 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500" />
